    ...
    return (
        <div className='flex flex-col gap-4'>
            <div className="flex gap-3 items-center">
                ...
                <div className="px-3 py-1.5 border border-white/10 rounded-lg text-sm w-72 bg-transparent flex items-center gap-3">
                ...
                <table className='w-full'>
                    ...
                    <tbody>
                        {Array.from({ length: 10 }).map((_, indice) => {
                            return (
                                <tr key={indice} className='border-b border-white/10 hover:bg-white/5'>
                                    ...
                                    <td className='py-3 px-4 text-sm text-left text-zinc-300'>
                                        <div className='flex flex-col gap-1'>
                                            <span className='font-semibold text-white'>Guilheme Santos</span>
                                            <span>guilhermedev2004@hotmail.com</span>
                                        </div>
                                    </td>
