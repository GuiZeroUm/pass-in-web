...
export function AttendeeList() {
    ...
    function onSearchInputChanged(evento: ChangeEvent<HTMLInputElement>) {

        setValorDoInput(evento.target.value)
    }
            ...
            <Table>
                ...
                <tfoot>
                        <tr>
                            ...
                            <TableCell className='font-semibold text-right' colSpan={3}>
